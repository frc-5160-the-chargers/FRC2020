...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [26.02337445029256, 60.99182953033291]
        self.__hsv_threshold_saturation = [84.08273454192731, 255.0]
        self.__hsv_threshold_value = [151.19603733364633, 255.0]
